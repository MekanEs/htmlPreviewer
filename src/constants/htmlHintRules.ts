        ...
        parser.addListener('tagend', (event) => {
            ...
            if (pos >= 0) {
                ...
                if (arrTags.length > 0) {
                    ...
                    reporter.error(`Tag must be paired, missing: [ ${arrTags.join('')} ], start tag match failed [ ${lastEvent.raw} ] on line ${lastEvent.line}.`, lastEvent.line, event.col, this, event.raw);
                    // here
                }
                stack.length = pos;
            }
